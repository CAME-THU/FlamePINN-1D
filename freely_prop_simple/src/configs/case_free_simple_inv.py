...
class Case:
    def __init__(self, args):
        ...
        self.var_lam_s = None if args.know_lam else dde.Variable(args.lam_ini * args.scale_lam, dtype=dtype)
        self.var_Ea_s = None if args.know_Ea else dde.Variable(args.Ea_ini * args.scale_Ea, dtype=dtype)
    ...
    def ode(self, x, T):
        ...
        lam = self.lam if args.know_lam else self.var_lam_s / args.scale_lam
        Ea = self.Ea if args.know_Ea else self.var_Ea_s / args.scale_Ea
